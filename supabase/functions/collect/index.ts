...
const QUERIES = [
  ...
  { q: "ポケモンカード BOX 再販", cat: "tcg" },
  { q: "Nintendo Switch 2 抽選", cat: "game" },
  { q: "ガンプラ 予約 抽選", cat: "hobby" },
  { q: "ウイスキー 抽選 販売", cat: "liquor" },
  { q: "山崎 ウイスキー 抽選", cat: "liquor" },
  { q: "日本酒 限定 抽選", cat: "liquor" },
  { q: "ユニクロ コラボ 発売", cat: "fashion" },
  { q: "シュプリーム 発売", cat: "fashion" },
  { q: "エルメス 限定", cat: "fashion" },
  { q: "ブランド 限定 コラボ 発売", cat: "fashion" },
  { q: "レコード 限定盤 発売", cat: "other" },
  { q: "G-SHOCK 限定 発売", cat: "gadget" },
  { q: "腕時計 限定 抽選", cat: "gadget" },
  { q: "ジブリ 限定 グッズ", cat: "chara" },
  { q: "ディズニー 限定 発売", cat: "chara" },
  { q: "ディズニー 抽選", cat: "chara" },
  { q: "記念硬貨 発売", cat: "coin" },
  { q: "記念貨幣 申込", cat: "coin" },
  { q: "抽選販売 受付", cat: "other" },
...
const CATEGORY_RULES: { cat: string; re: RegExp }[] = [
  ...
  { cat: "chara", re: /ジブリ|トトロ|千と千尋|ジブリパーク|ディズニー|Disney|ミッキー|ダッフィー|ツイステ|ピクサー/i },
  { cat: "coin", re: /記念硬貨|記念貨幣|造幣局|記念切手|プルーフ貨幣/i },
  ...
  { cat: "fashion", re: /ユニクロ|UNIQLO|\bGU\b|Supreme|シュプリーム|エルメス|アパレル|Tシャツ|パーカー|スウェット/i },
